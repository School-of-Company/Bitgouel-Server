...
//            property(School::name) { HighSchool.GWANGJU_SOFTWARE_MEISTER_HIGH_SCHOOL }
//        }
...
//        }
//
//        every { schoolRepository.findByName(highSchool) } returns school
...
//            every { schoolRepository.findByName(highSchool) } returns null
//
